...
public class BootAnims extends ListActivity {
	String name;
	...
	static final String URL = "http://bitterrific.com/bootanims.xml";
	// XML node keys
	...
	/*	((PullToRefreshListView) getListView()).setOnRefreshListener(new OnRefreshListener() {
		...
		*/
		...
		SharedPreferences prefs = PreferenceManager
			    .getDefaultSharedPreferences(BootAnims.this);
			 
			   String username = prefs.getString("username", "Shadow");
		
		setTitle(username + " Boot animations");

		 boolean skins = prefs.getBoolean("bootanimations", true);
	...
	class DownloadMapAsync extends AsyncTask<String, String, String> {
		...
		try {
			...
			outputfile = new File("/sdcard/Shadow/Downloads/", name+".zip");
		...
		protected void onPostExecute(String unused) {
			...
			if(result.equalsIgnoreCase("true")){
				...
				final File download = new File("/sdcard/Shadow/Downloads/", name+".zip");
				...
				install.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int id) {
						...
						try { Process process = Runtime.getRuntime().exec(new String[]{ "su", "-c", "busybox cp /sdcard/Shadow/Downloads/"+name+".zip", "/system/customize/resource/hTc_bootup.zip"}); } 
						catch (Exception ex) { ex.printStackTrace(); }
		 ...
		 lv.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
			...
			lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> parent, View view,
					...
					File file = new File(Environment.getExternalStorageDirectory()+"/Shadow/Downloads/", name+".zip");
...
class InstallAnim extends AsyncTask<String, String, String> {
    ...
    @Override
    protected String doInBackground(String... name1) {
        /*
                    make connection & download XML here, 
                    use your XML parser class object to parse the xml from here
		...
		try { Process process = Runtime.getRuntime().exec(new String[]{ "su", "-c", "busybox cp /sdcard/Shadow/Downloads/"+name1+".zip", "/system/customize/resource/hTc_bootup.zip"}); } 
		catch (Exception ex) { ex.printStackTrace(); }
